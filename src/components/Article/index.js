        ...
        (isLoading) ?
            ...
            <div className="loading-overlay">
                <div className="loading-container">
                    <span className="loading-text"><img src={require('../../images/uniting-icon.png')} style={{
                        filter: 'brightness(0) invert(1)',
                        width: '150px',
                        height: 'auto',
                        marginBottom: '10px'
                    }} alt={"Uniting Logo"}/> </span>
            ...
            <ArticleContainer>
                <WarningContainer>
                    ...
                    <WarningText>
                        ...
                        <a href="https://app.smartsheet.com/b/form/7194d9dfdead439286d551134f8d515c" target="_blank"
                           rel="noopener noreferrer" style={{color: '#fff', textDecoration: 'underline'}}>
                ...
                <FilterContainer>
                    ...
                    {
                        (searchError) ?
                            <Typography variant="subtitle" sx={{color: 'red', marginBottom: '-0.8rem'}}>--Search No
                ...
                <SMMapElement>
                    <MapResultFilter importRef={mapRef} importSite={selectedSite}
                                     advanceFilteredPrograms={(advanceFilteredPrograms.length > 0) ? advanceFilteredPrograms : filteredPrograms}
