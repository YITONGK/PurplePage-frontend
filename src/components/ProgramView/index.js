                    ...
                    <TableBody>
                        {sites.map((site, index) => (
                            ...
                            >
                                ...
                                <TableCell
                                    style={TableContentStyle}>{site.street_nbr} {site.street_name}, {site.suburb}, {site.state} {site.postcode}</TableCell>
                                ...
                                <TableCell
                                    style={TableContentStyle}> {(site.accessibility && site.accessibility.accessibility) ? stringFilterPrefix(site.accessibility.accessibility) : 'None'}</TableCell>
                                <TableCell
                                    style={TableContentStyle}>{stringFilterPrefix(site.site_contact_name)}</TableCell>
                                <TableCell style={{width: '10px'}}>
                                    <Button variant="contained" style={{
                                        textTransform: "none",
                                        marginRight: "5%",
                                        backgroundColor: '#A60A6C'
                                    }}>
    ...
    return (
        <ProgramViewContainer>
            <MapAndInfoContainer>
                ...
                <ProgramViewMapContainer>
                    <Map sites={sites} exportRef={mapRef} exportSite={ExportSite} mapZoom={6} mapWidth={53}
                         mapHeight={50}/>
                </ProgramViewMapContainer>
            </MapAndInfoContainer>
            <ProgramViewP style={{
